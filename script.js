...
const res1 = strings.filter((value) => {
...
const res3 = alphabets.reduce((initial,curr)=>{
  return initial+curr
})
console.log(res3)
...
const res5 = ranks.findIndex((value)=>{
  return value==7
})
console.log(res5)
...
//3:8
const num = [2, 4, 6, 8];
const res6 = num.forEach((item,index,num)=>{
...
const res8 = positive.every((value)=>{
  return value>0
})
console.log(res8)
...
console.log(person)
const res10a = person.hasOwnProperty('bike')
console.log(res10a)
const res10b = person.hasOwnProperty('house')
console.log(res10b)
...
const res10c = Object.keys(person)
console.log(res10c)
